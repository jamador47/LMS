...
<nav class="navbar navbar-expand-lg navbar-light dashboard-top-nav">
    <div class="dashboard-top-navbar-brand">
        <a class="navbar-brand" href="{{route('home')}}">
            ...
            @else
                <img src="{{asset('assets/images/logocmh_solo_texto.png')}}" alt="{{get_option('site_title')}}" />
            @endif
        </a>
    </div>
            ...
            <div id="page-wrapper">
                ...
                <div class="admin-footer">
                    <div class="container">
                        <div class="row">
                            <div class="col-md-12">
                                <p class="m-0"><a href="https://themeqx.com/product/teachify-lms" target="_blank">Teachify LMS</a> Version {{config('app.version')}}</p>
                            </div>
                        </div>
                    </div>
                </div>
